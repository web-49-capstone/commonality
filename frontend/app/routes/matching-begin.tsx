    ...
    return(
        <>
            <div className="container mx-auto">
                <div className="grid grid-cols-1 lg:grid-cols-2 mt-5 lg:mt-15">
                    <div className="text-center">
                        ...
                        <p className="text-xl text-gray-900">Pick an interest from your profile to see other users with the same interest.</p>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 mt-5 lg:mt-0">
