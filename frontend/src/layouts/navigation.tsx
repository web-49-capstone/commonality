            ...
            <nav>
                ...
                <div className="md:block bg-white border-b shadow-lg pb-2">
                    ...
                    <div className="md:flex hidden justify-center items-center gap-10 min-h-8">
                        <Link id="desktop-messages-link" className="flex items-center gap-2 text-lg text-gray-700 hover:text-blue-700 hover:border-b-2" href="/messages"><MdOutlineMessage />Messages</Link> |
                        <Link id="desktop-connect-link" className="flex items-center gap-2 text-lg text-gray-700 hover:text-blue-700 hover:border-b-2" href="/connect"><PiPlugsConnectedFill />Make Connections</Link> |
                        <Link id="desktop-profile-link" className="flex items-center gap-2 text-lg text-gray-700 hover:text-blue-700 hover:border-b-2" href="/profile"><CgProfile />Profile</Link>
                    </div>
                </div>
                ...
                <div className="md:hidden fixed bottom-0 w-full bg-white border-t shadow-inner z-50 text-gray-700">
                    <div className="md:hidden flex justify-evenly items-center gap-3 px-2 py-2 min-h-20">
                        <Link id="mobile-messages-link" className="flex flex-col items-center gap-2 text-md hover:text-blue-600 hover:border-b-2" href={"/messages"}><MdOutlineMessage />Messages</Link> |
                        <Link id="mobile-connect-link" className="flex flex-col items-center gap-2 text-md hover:text-blue-600 hover:border-b-2" href="/connect"><PiPlugsConnectedFill />Make Connections</Link> |
                        <Link id="mobile-profile-link" className="flex flex-col items-center gap-2 text-md hover:text-blue-600 hover:border-b-2" href="/profile"><CgProfile />Profile</Link>
                    </div>
