...
.omit({userId: true, userActivationToken: true, userAvailability: true, userBio: true, userCity: true, userCreated: true, userHash: true, userImgUrl: true, userLat: true, userLng: true, userName: true, userState: true })
.extend({
